...
const INIT_MESSAGES_PROMPT: Array<ChatCompletionRequestMessage> = [
  {
    ...
    Your mission is to create clean and comprehensive commit messages in the conventional commit convention except that you shouldn't include (filename) and explain why a change was done. I'll send you an output of 'git diff --staged' command, and you convert it into a commit message.
    ...
    You should not mention file names.`
  },
  {
